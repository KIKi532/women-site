...
SECRET_KEY = 'django-insecure-63y-(^b)w8klmrueg=@n-psm!i2ag%64mnd*n*p$06%c&vi*%*'

# django-insecure-63y-(^b)w8klmrueg=@n-psm!i2ag%64mnd*n*p$06%c&vi*%*
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'sitewomen_cache'),
    }
}
